...
def learn(x, y, test_x):
    ...
    print ("n_estimators=", variables.n_estimators_et, "max_depth=", variables.max_depth_et, "min_samples_split=", variables.min_samples_split_et, "min_samples_leaf=", variables.min_samples_leaf_et)
    print ("max_features=",variables.max_feature_et, "max_leaf_nodes=",variables.max_leaf_nodes_et, "criterion=",variables.criterion_et, "min_impurity_split=",variables.min_impurity_split_et)
